...
logic signed 	[31:0] 	real_out_div,image_out_div ;

logic signed 	[31:0]	FFT_1_image_in_;

assign real_out_div		= {{6{FFT_1_real_out[31]}},FFT_1_real_out[30:21],FFT_1_real_out[20:5]} ;
assign image_out_div 	= {{6{FFT_1_image_out[31]}},FFT_1_image_out[30:21],FFT_1_image_out[20:5]} ;

assign FFT_1_image_in_ = -FFT_1_image_in;
